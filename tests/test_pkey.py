...
class ParseTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.ecdsa_str = (
            open(_support("test_ecdsa_password_256.key")).read().strip()
        )
    ...
    def test_parse_old_password(self):
        ...
        self.assertEqual(pkformat, PKey._PRIVATE_KEY_FORMAT_ORIGINAL)
    ...
    def test_parse_new(self):
        ...
        self.assertEqual(pkformat, PKey._PRIVATE_KEY_FORMAT_OPENSSH)
