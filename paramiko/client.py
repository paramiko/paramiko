...
class SSHClient (ClosingContextManager):
    ...
    def get_socket(self, hostname, port=SSH_PORT, timeout=None):
    ...
    def setup_transport(self, hostname, sock, compress=False, gss_kex=False,
        ...
        """
        t = self._transport = self.Transport(sock, gss_kex=gss_kex,
    ...
    def setup_hostkey(self, hostname, port):
        """Set up the server host key.
    ...
    def connect(self, hostname, port=SSH_PORT, username=None, password=None, pkey=None,
        ...
        """
        if not sock:
            sock = self.get_socket(hostname, port=port, timeout=None)

        self.setup_transport(hostname, sock, compress=compress, gss_kex=gss_kex,
                             gss_deleg_creds=gss_deleg_creds,
                             gss_host=gss_host, banner_timeout=banner_timeout)

        self.setup_hostkey(hostname, port)
